...
class kitchenWindow:
    def __init__(self):
        self.__kitchenScreen = tkinter.Tk()
        ...
        self.__topFrame = tkinter.Frame(self.__kitchenScreen)
        self.__midFrame = tkinter.Frame(self.__kitchenScreen)
        self.__botFrame = tkinter.Frame(self.__kitchenScreen)
        ...
        self.__pic = tkinter.PhotoImage(file='kitchen.gif')
